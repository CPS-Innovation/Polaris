...
namespace coordinator.Functions
{
    public class CaseClient
    {
        ...
        public async Task<HttpResponseMessage> Run
            (
                [HttpTrigger(AuthorizationLevel.Anonymous, "delete", "post", Route = RestApi.Case)] HttpRequestMessage req,
                string caseUrn,
                string caseId,
            ...
            )
        {
            ...
            catch (Exception exception)
            {
                ...
                _logger.LogMethodError(currentCorrelationId, nameof(CaseClient), errorMessage, exception);
