...
namespace coordinator.Durable.Orchestration
{
    public class RefreshDocumentOrchestrator
    {
        ...
        public async Task<RefreshDocumentOrchestratorResponse> Run([OrchestrationTrigger] TaskOrchestrationContext context)
        {
            ...
            {
                return new RefreshDocumentOrchestratorResponse { PdfConversionResponse = pdfConversionResponse, DocumentId = payload.MaterialId };
            }
            ...
            await context.CallActivityAsync(nameof(SetDocumentPdfConversionSucceeded), new CaseIdAndDocumentIdPayload { CaseId = payload.CaseId, DocumentId = payload.MaterialId });

            var telemetryEvent = new IndexedDocumentEvent(payload.CorrelationId)
            {
                CaseUrn = payload.Urn,
                CaseId = payload.CaseId,
                DocumentId = payload.MaterialId,
            ...
            try
            {
                ...
                await context.CallActivityAsync(nameof(SetDocumentIndexingSucceeded),new CaseIdAndDocumentIdPayload { CaseId = payload.CaseId, DocumentId = payload.MaterialId });
            ...
            catch (Exception exception)
            {
                ...
                return new RefreshDocumentOrchestratorResponse { PdfConversionResponse = pdfConversionResponse, StoreCaseIndexesResponse = new StoreCaseIndexesResult { IsSuccess = false }, DocumentId = payload.MaterialId };
            }
        }
        ...
        private async Task<PdfConversionResponse> EnsurePdfExists(DocumentPayload payload, TaskOrchestrationContext context, ILogger log)
        {
            try
            {
                ...
                {
                    await context.CallActivityAsync(nameof(SetDocumentPdfConversionFailed), new SetDocumentPdfConversionStatusPayload { CaseId = payload.CaseId, DocumentId = payload.MaterialId, PdfConversionStatus = pdfConversionResponse.PdfConversionStatus });
            ...
            {
                await context.CallActivityAsync(nameof(SetDocumentPdfConversionFailed), new SetDocumentPdfConversionStatusPayload { CaseId = payload.CaseId, DocumentId = payload.MaterialId, PdfConversionStatus = PdfConversionStatus.UnexpectedError });
