...
namespace coordinator.Clients.Contracts
{
    ...
    {
        Task ExtractTextAsync(PolarisDocumentId polarisDocumentId, string cmsCaseUrn, long cmsCaseId, string cmsDocumentId, long versionId, string documentTypeId, string documentType, string documentCategory, string blobName, Guid correlationId, Stream documentStream);
