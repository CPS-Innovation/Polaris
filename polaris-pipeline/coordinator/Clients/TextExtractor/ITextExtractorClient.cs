...
namespace coordinator.Clients.TextExtractor
{
    ...
    {
        Task<ExtractTextResult> StoreOcrResultsAsync(PolarisDocumentId polarisDocumentId, string cmsCaseUrn, long cmsCaseId, string cmsDocumentId, long versionId, string blobName, Guid correlationId, Stream ocrResults);
