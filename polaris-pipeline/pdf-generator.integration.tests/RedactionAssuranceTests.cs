...
namespace pdf_generator_integration.tests
{
  public class RedactionAssuranceTests
  {
    ...
    public async Task RedactionAssurance(string pdfResourcePath, string redactionJsonPath, string assertionImageOnePath, string assertionImageTwoPath)
    {
      ...
      var redactionData = LoadRedactionDataFromJson(redactionJsonPath);
      ...
      SaveFile(inputStream, "input.pdf");
      SaveFile(outputStream, "output.pdf");
      // SaveFile(redactedImageStreams[0], "img_generated.png");
      // SaveFile(redactedImageStreams[1], "img_generated_2.png");
      // SaveFile(assertionImageStreamOne, "img_assert.png");
      // SaveFile(assertionImageStreamTwo, "img_assert_2.png");
      ...
      // using (var maskImage = ImageSharpCompare.CalcDiffMaskImage(redactedImageStreams[0], assertionImageStreamOne))
    ...
    private RedactPdfRequestDto LoadRedactionDataFromJson(string jsonPath)
    {
