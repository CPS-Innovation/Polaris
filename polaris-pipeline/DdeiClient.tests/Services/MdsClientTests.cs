...
//        var loggerMock = new Mock<ILogger<MdsClient>>();
...
//        var mockHttpRequestFactory = new Mock<IMdsClientRequestFactory>();
...
//        await Assert.ThrowsAsync<DdeiClientException>(() => _mdsClient.ListDocumentsAsync(_ddeiCaseIdentifiersArgDto));
//    }
...
//        try
//        {
//            await _mdsClient.ListDocumentsAsync(_ddeiCaseIdentifiersArgDto);
//        }
...
//    {
//        var result = await _mdsClient.ListDocumentsAsync(_ddeiCaseIdentifiersArgDto);
