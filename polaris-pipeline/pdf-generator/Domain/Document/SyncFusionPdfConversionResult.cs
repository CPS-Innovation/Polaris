...
public class SyncFusionPdfConversionResult
{
    public SyncFusionPdfConversionResult(string documentId, SyncFusionPdfConverterType conversionHandler)
    {
    ...
    public SyncFusionPdfConverterType ConversionHandler { get; set; }
