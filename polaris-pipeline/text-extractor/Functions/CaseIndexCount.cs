...
namespace text_extractor.Functions
{
    public class CaseIndexCount
    {
        ...
        public CaseIndexCount(ILogger<CaseIndexCount> log, ISearchIndexService searchIndexService, IJsonConvertWrapper jsonConvertWrapper, ITelemetryAugmentationWrapper telemetryAugmentationWrapper, IExceptionHandler exceptionHandler)
        {
