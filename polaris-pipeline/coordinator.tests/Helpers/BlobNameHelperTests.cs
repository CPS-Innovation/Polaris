...
public class BlobNameHelperTests
{
    ...
    public void PdfBlobNameHelper_ReturnsExpectedPdfBlobName(int caseId, string cmsOrPolarisDocumentId, BlobNameHelper.BlobType blobType, string expected)
    {
        // Act
        var result = BlobNameHelper.GetBlobName(caseId, cmsOrPolarisDocumentId, blobType);
