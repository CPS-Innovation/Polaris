...
namespace coordinator.tests
{
    internal static class Mother
    {
        ...
        public static Func<ReconciledPiiEntity> ReconciledPiiEntity1 { get; } = () =>
            new(OcrLineResult1(), new coordinator.Services.OcrResultsService.OcrWord(Word4(), 15), "PersonType", "Occupation", "CMS-112233", Guid.NewGuid());

        public static Func<ReconciledPiiEntity> ReconciledPiiEntity2 { get; } = () =>
            new(OcrLineResult1(), new coordinator.Services.OcrResultsService.OcrWord(Word12(), 61), "PersonType", "Occupation", "CMS-112233", Guid.NewGuid());
