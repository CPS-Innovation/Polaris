...
namespace pdf_redactor.tests.Functions
{
  public class PdfRedactorTests
  {
    ...
    private readonly Mock<ILogger<PdfRedactor>> _loggerMock;
    private readonly Mock<IValidator<RedactPdfRequestWithDocumentDto>> _mockValidator;
    private readonly PdfRedactor _pdfRedactor;
    ...
    public PdfRedactorTests()
    {
      ...
      _loggerMock = new Mock<ILogger<PdfRedactor>>();
