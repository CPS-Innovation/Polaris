...
public static class LoggingConstants
{
    ...
    /// <summary>
    /// CheckCaseLock operation success log message.
    /// </summary>
    public const string CheckCaseLockOperationSuccess = "{0} Successfully checked case lock for caseId [{1}]";
    ...
    /// CaseLockRelease operation failed log message.
    /// </summary>
    public const string CheckCaseLockOperationFailed = "{0} Failed to check case lock for caseId [{1}]";
