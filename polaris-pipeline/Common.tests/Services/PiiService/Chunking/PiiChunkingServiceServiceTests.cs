...
namespace Common.tests.Services.OcrResultsServiceTests
{
    public class PiiChunkingServiceServiceTests
    {
        private readonly ReadResult _readResult;
        private readonly PiiChunkingService _piiChunkingService;
        ...
        public PiiChunkingServiceServiceTests()
        {
            ...
            _piiChunkingService = new PiiChunkingService();
