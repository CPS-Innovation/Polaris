...
{ 
    public class GenerateThumbnail
    {
        ...
        public GenerateThumbnail(ILogger<GenerateThumbnail> logger, DurableTaskClient durableOrchestrationClient, IOrchestrationProvider orchestrationProvider, IExceptionHandler exceptionHandler)
        { 
            _logger = logger;
