...
public class SlidingClearDown
{
  ...
  public SlidingClearDown(ILogger<SlidingClearDown> logger, IConfiguration configuration, ICleardownService cleardownService, IOrchestrationProvider orchestrationProvider)
  {
    _logger = logger;
  ...
  [FunctionName(nameof(SlidingClearDown))]
  [ProducesResponseType(StatusCodes.Status200OK)]
  [ProducesResponseType(StatusCodes.Status500InternalServerError)]

  public async Task RunAsync([TimerTrigger("%SlidingClearDownSchedule%")] TimerInfo myTimer, DurableTaskClient client)
  {
