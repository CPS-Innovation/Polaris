...
namespace Ddei.Mappers
{
    public interface ICaseDetailsMapper
    {
        ...
        CaseDto MapCaseDetails((CaseSummaryDto Summary, IEnumerable<PcdRequestDto> PreChargeDecisionRequests, IEnumerable<DefendantAndChargesDto> DefendantsAndCharges, IEnumerable<BaseCaseWitnessResponse> Witnesses) caseDetails);
