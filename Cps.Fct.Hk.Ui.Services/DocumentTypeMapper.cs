...
public class DocumentTypeMapper : IDocumentTypeMapper
{
    ...
    public DocumentTypeMapper(ILogger<DocumentTypeMapper> logger)
    {
        ...
        this.documentTypeMapping = new Dictionary<int, DocumentTypeInfo>
        {
            ...
            { 1059, new DocumentTypeInfo { DocumentType = "MG11(R) or MG11(B)", Category = "Statements", Group = "Statements" } },
            ...
            { 1058, new DocumentTypeInfo { DocumentType = "PCN3", Category = "Unused Material", Group = "Other" } },
            ...
            { 1202, new DocumentTypeInfo { DocumentType = "SDC Streamlined Disclosure Certificate", Category = "Unused Material", Group = "Other" } },
            ...
            { 100239, new DocumentTypeInfo { DocumentType = "EG3", Category = "Unused Material" } },
            { 226148, new DocumentTypeInfo { DocumentType = "EG3", Category = "Unused Material" } },
            { 227, new DocumentTypeInfo { DocumentType = "CAP01", Category = "Communication" } },
            { 101, new DocumentTypeInfo { DocumentType = "MG3", Category = "Communication" } },
            { 102, new DocumentTypeInfo { DocumentType = "MG3A", Category = "Communication" } },
            { 104, new DocumentTypeInfo { DocumentType = "MG3AS", Category = "Communication" } },
            { 103, new DocumentTypeInfo { DocumentType = "MG3S", Category = "Communication" } },
            { 189, new DocumentTypeInfo { DocumentType = "REV1", Category = "Communication" } },
            { 212, new DocumentTypeInfo { DocumentType = "REVIEW", Category = "Communication" } },
            { 1016, new DocumentTypeInfo { DocumentType = "MG 11(CONT)", Category = "Statements" } },
            { 1017, new DocumentTypeInfo { DocumentType = "MG 11(T)", Category = "Statements" } },
            { 1018, new DocumentTypeInfo { DocumentType = "MG 11T(CONT)", Category = "Statements" } },
            { 1021, new DocumentTypeInfo { DocumentType = "MG 15(CONT)", Category = "Exhibits" } },
