...
public class DocumentTypeMapper : IDocumentTypeMapper
{
    ...
    public DocumentTypeMapper(ILogger<DocumentTypeMapper> logger)
    {
        ...
        this.documentTypeMapping = new Dictionary<int, DocumentTypeInfo>
        {
            ...
            { 1009, new DocumentTypeInfo { DocumentType = "MG6C", Category = "Unused Material", Group = "MG Form" } },
            { 1010, new DocumentTypeInfo { DocumentType = "MG6D", Category = "Unused Material", Group = "MG Form" } },
            { 1011, new DocumentTypeInfo { DocumentType = "MG6E", Category = "Unused Material", Group = "MG Form" } },
            ...
            { 1059, new DocumentTypeInfo { DocumentType = "MG11(R) or MG11(B)", Category = "Statements" } },
            ...
            { 1028, new DocumentTypeInfo { DocumentType = "MG/FSSB", Category = "Exhibits", Group = "Exhibits" } },
            ...
            { 1200, new DocumentTypeInfo { DocumentType = "Other Material", Category = "Communication", Group = "Communication" } },
            { 1056, new DocumentTypeInfo { DocumentType = "PCN1", Category = "Defendant Pre Cons", Group = "Defendant Pre Cons" } },
            { 1057, new DocumentTypeInfo { DocumentType = "PCN2", Category = "Defendant Pre Cons", Group = "Defendant Pre Cons" } },
            { 1058, new DocumentTypeInfo { DocumentType = "PCN3", Category = "Unused Material", Group = "MG Form" } },
            { 1051, new DocumentTypeInfo { DocumentType = "PE1", Category = "Statements", Group = "Statements" } },
            { 1052, new DocumentTypeInfo { DocumentType = "PE2", Category = "Exhibits", Group = "Exhibits" } },
            { 1053, new DocumentTypeInfo { DocumentType = "PE3", Category = "Communication", Group = "Communication" } },
            { 1054, new DocumentTypeInfo { DocumentType = "PE4", Category = "Communication", Group = "Communication" } },
            { 1202, new DocumentTypeInfo { DocumentType = "SDC Streamlined Disclosure Certificate", Category = "Unused Material", Group = "MG Form" } },
            ...
            { 100239, new DocumentTypeInfo { DocumentType = "EG3", Category = "Unused Material", Group = "Exhibit" } },
            { 226148, new DocumentTypeInfo { DocumentType = "EG3", Category = "Unused Material", Group = "Exhibit" } },
            { 227, new DocumentTypeInfo { DocumentType = "CAP01", Category = "Communication", Group = "Communication" } },
            { 101, new DocumentTypeInfo { DocumentType = "MG3", Category = "Communication", Group = "Communication" } },
            { 102, new DocumentTypeInfo { DocumentType = "MG3A", Category = "Communication", Group = "Communication" } },
            { 104, new DocumentTypeInfo { DocumentType = "MG3AS", Category = "Communication", Group = "Communication" } },
            { 103, new DocumentTypeInfo { DocumentType = "MG3S", Category = "Communication", Group = "Communication" } },
            { 189, new DocumentTypeInfo { DocumentType = "REV1", Category = "Communication", Group = "Communication" } },
            { 212, new DocumentTypeInfo { DocumentType = "REVIEW", Category = "Communication", Group = "Communication" } },
            { 1016, new DocumentTypeInfo { DocumentType = "MG 11(CONT)", Category = "Statements", Group = "Statements" } },
            { 1017, new DocumentTypeInfo { DocumentType = "MG 11(T)", Category = "Statements", Group = "Statements" } },
            { 1018, new DocumentTypeInfo { DocumentType = "MG 11T(CONT)", Category = "Statements", Group = "Statements" } },
            { 1021, new DocumentTypeInfo { DocumentType = "MG 15(CONT)", Category = "Exhibits", Group = "Exhibits" } },
            { 1022, new DocumentTypeInfo { DocumentType = "MG 15(T)", Category = "Exhibits", Group = "Exhibits" } },
            { 1023, new DocumentTypeInfo { DocumentType = "MG 15(T)(CONT)", Category = "Exhibits", Group = "Exhibits" } },
            { 1406, new DocumentTypeInfo { DocumentType = "ABE Recording", Category = "Exhibits", Group = "Exhibits" } },
            { 225522, new DocumentTypeInfo { DocumentType = "999Wav", Category = "Exhibits", Group = "Exhibits" } },
        };
    }
