...
cp env-variable-substitution/substitute-config.js build/substitute-config.js
cp env-variable-substitution/run-substitution-locally.sh build/run-substitution-locally.sh