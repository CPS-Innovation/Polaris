  ...
  return (
    <PageContentWrapper>
      ...
      <p className="govuk-body-l">
        Casework App only works if you are using it in the same browser in which
        you are logged in to CMS. Usually this means that you would have CMS
        open in your Edge browser in one tab and Casework App open in another
        tab.
      </p>
