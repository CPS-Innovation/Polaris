...
//   it.skip("should return the correct unSavedRedactionDocs array", () => {
...
//   it.skip("Should return empty array if the there are no active redactions in any document items", () => {
