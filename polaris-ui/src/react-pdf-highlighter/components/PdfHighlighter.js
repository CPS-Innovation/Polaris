...
export class PdfHighlighter extends PureComponent {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pdfjs = yield import("pdfjs-dist/web/pdf_viewer.mjs");
    ...
    findOrCreateHighlightLayer(page) {
        ...
        return findOrCreateContainerLayer(textLayer.div, "PdfHighlighter__highlight-layer");
    }
    ...
    renderHighlightLayers() {
        ...
        for (let pageNumber = 1; pageNumber <= pdfDocument.numPages; pageNumber++) {
            ...
            if (highlightRoot === null || highlightRoot === void 0 ? void 0 : highlightRoot.container.isConnected) {
