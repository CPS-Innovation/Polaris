...
describe("Save User Data", () => {
  ...
  describe("unsaved redactions", () => {
    ...
    it.only("Should be able to apply unsaved redactions between page refresh and closing and opening of the document tab, and should be able continue adding more redactions until we successfully save the redactions ", () => {
