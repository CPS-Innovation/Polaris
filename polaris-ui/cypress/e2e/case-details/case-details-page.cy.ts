...
describe("case details page", () => {
  ...
  describe("case details", () => {
    ...
    it("For Single defendant and single charge, shouldn't show firstname and date of birth as defendant details, if the defendant is an organisation ", () => {
    ...
    it("For multiple defendant, shouldn't show firstname if the defendant is an organisation ", () => {
      cy.visit("/case-search-results?urn=12AB1111111");
