...
describe("redaction refresh flow", () => {
  ...
  it(
    "Should show error message when failed to save the redaction",
    { defaultCommandTimeout: 15000 },
    () => {
      cy.overrideRoute(
        SAVE_REDACTION_ROUTE,
  ...
  it(
    "Should handle the deleted document opened in a tab after the pipeline refresh and display document deleted message to user",
    { defaultCommandTimeout: 15000 },
    () => {
