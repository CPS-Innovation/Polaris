...
{
    Task<ContentResult> GetUrnFromCaseIdAsync(int caseId, string? cmsAuthValues, Guid correlationId);
    ...
    Task<ContentResult> ReclassifyDocument(string caseUrn, int caseId, PolarisDocumentId polarisDocumentId, ReclassifyDocumentDto reclassifyDocumentDto, string? cmsAuthValues, Guid correlationId);
    ...
    Task<ContentResult> GetWitnessStatementsAsync(string caseUrn, int caseId, int witnessId, string? cmsAuthValues, Guid correlationId);
}