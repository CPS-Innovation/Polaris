...
public class PolarisPipelineCase : BaseFunction
{
    ...
    [OpenApiOperation(operationId: nameof(PolarisPipelineCase), tags: ["Cases"], Summary = "Polaris Pipeline Case", Description = "Returns case information using caseURN and caseId")]
