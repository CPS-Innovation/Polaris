...
public class GetCaseLegacy : BaseFunction
{
    private readonly ILogger<GetCaseLegacy> _logger;
    private readonly IMdsArgFactory _mdsArgFactory;
    private readonly IMdsCaseOrchestrationService _mdsOrchestrationService;

    public GetCaseLegacy(
        ILogger<GetCaseLegacy> logger,
    ...
    [Function(nameof(GetCaseLegacy))]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [OpenApiOperation(operationId: nameof(GetCaseLegacy), tags: ["Case"], Summary = "Get Case", Description = "Returns case information using caseURN and caseId")]
    ...
    public async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = RestApi.CaseLegacy)] HttpRequest req, string caseUrn, int caseId, CancellationToken cancellationToken = default)
    {
