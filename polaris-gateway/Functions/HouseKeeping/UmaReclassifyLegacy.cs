// <copyright file="UmaReclassifyLegacy.cs" company="TheCrownProsecutionService">
...
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="UmaReclassifyLegacy"/> class.
/// </remarks>
...
public class UmaReclassifyLegacy(
    ILogger<UmaReclassifyLegacy> logger,
    ICommunicationService communicationService,
    IUmaReclassifyService umaReclassifyService,
    IBulkSetUnusedService bulkSetUnusedService) : BaseFunction(logger)
{
    private readonly ILogger<UmaReclassifyLegacy> logger = logger;
    ...
    [OpenApiOperation(operationId: nameof(UmaReclassifyLegacy), tags: ["Material"], Description = "Represents a function that automatically sets materials to unused.")]
    ...
    [Function("UmaReclassifyLegacy")]
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = RestApi.UmaReclassifyLegacy)] HttpRequest req, int caseId, CancellationToken cancellationToken = default)
    {
        try
        {
            var stopwatch = Stopwatch.StartNew();
            this.logger.LogInformation($"{LoggingConstants.HskUiLogPrefix} UmaReclassifyLegacy function processed a request.");
        ...
        {
            this.logger.LogError($"{LoggingConstants.HskUiLogPrefix} UmaReclassifyLegacy function encountered an error: {ex.Message}");
