...
public class GetOcrLegacy : BaseFunction
{
    ...
    private readonly ILogger<GetOcrLegacy> _logger;
    private readonly IOcrArtefactService _ocrArtefactService;

    public GetOcrLegacy(
        ILogger<GetOcrLegacy> logger,
    ...
    [Function(nameof(GetOcrLegacy))]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [OpenApiOperation(operationId: nameof(GetOcrLegacy), tags: ["Documents"], Summary = "Artefact Result", Description = "Gives the artefact results")]
    ...
    public async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = RestApi.OcrLegacy)] HttpRequest req, string caseUrn, int caseId, string materialId, long documentId, CancellationToken cancellationToken = default)
    {
