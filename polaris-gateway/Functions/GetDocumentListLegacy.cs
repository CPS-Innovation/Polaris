...
public class GetDocumentListLegacy : BaseFunction
{
    private readonly ILogger<GetDocumentListLegacy> _logger;
    private readonly IMdsCaseDocumentsOrchestrationService _mdsOrchestrationService;
    private readonly IMdsArgFactory _mdsArgFactory;

    public GetDocumentListLegacy(
        ILogger<GetDocumentListLegacy> logger,
    ...
    [Function(nameof(GetDocumentListLegacy))]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [OpenApiOperation(operationId: nameof(GetDocumentListLegacy), tags: ["Documents"], Summary = "Get Document List", Description = "Getting the list of documents")]
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = RestApi.DocumentsLegacy)] HttpRequest req, string caseUrn, int caseId, CancellationToken cancellationToken = default)
    {
