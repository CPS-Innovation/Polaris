...
public class GetWitnessStatements : BaseFunction
{
    ...
    [OpenApiOperation(operationId: nameof(GetWitnessStatements), tags: ["Cases"], Summary = "Get Witnesses", Description = "Returns witnesses information using caseURN and caseId")]
