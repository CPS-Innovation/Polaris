...
public class PolarisPipelineCaseDeleteLegacy : BaseFunction
{
    private readonly ILogger<PolarisPipelineCaseDeleteLegacy> _logger;
    private readonly ICoordinatorClient _coordinatorClient;

    public PolarisPipelineCaseDeleteLegacy(
        ILogger<PolarisPipelineCaseDeleteLegacy> logger,
