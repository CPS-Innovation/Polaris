    ...
    public class GetOcr
    {
            ...
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = RestApi.Ocr)] HttpRequest req, string caseUrn, int caseId, string documentId, long versionId)
        {
            ...
            try
            {
                ...
                var ocrResult = await _ocrArtefactService.GetOcrAsync(context.CmsAuthValues, context.CorrelationId, caseUrn, caseId, documentId, versionId, isOcrProcessed, token);
