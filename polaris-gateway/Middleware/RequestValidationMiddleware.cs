    ...
    : IFunctionsWorkerMiddleware
{
    ...
    private readonly string[] _nonCmsAuthenticatedRoutes = [RestApi.CaseTracker, RestApi.CaseSearchCount, RestApi.CaseSearchLegacy];//"/api/login-full-cookie", , "/api/login", "/api/init"];
