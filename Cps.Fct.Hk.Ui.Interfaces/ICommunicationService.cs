...
public interface ICommunicationService
{
    ...
    /// <param name="cancellationToken">cancellationToken values for downstream systems.</param>
    /// <returns>An object that contains the renamed material id.</returns>
    Task<SetMaterialReadStatusResponse> SetMaterialReadStatusAsync(int materialId, MaterialReadStatusType action, CmsAuthValues cmsAuthValues, Guid correspondenceId = default, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">cancellationToken values for downstream systems.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
    public Task<UpdateExhibitResponse> UpdateExhibitAsync(int caseId, UpdateExhibitRequest exhibit, CmsAuthValues cmsAuthValues, Guid correspondenceId = default, CancellationToken cancellationToken = default);
