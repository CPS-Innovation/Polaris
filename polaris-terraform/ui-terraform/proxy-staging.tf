resource "azurerm_linux_web_app_slot" "polaris_proxy_staging1" {
  ...
  app_settings = {
    ...
    "DEFAULT_UPSTREAM_CMS_IP_CORSHAM"                 = var.cms_details.upstream_cms_ip_corsham
    "DEFAULT_UPSTREAM_CMS_MODERN_IP_CORSHAM"          = var.cms_details.upstream_cms_modern_ip_corsham
    "DEFAULT_UPSTREAM_CMS_IP_FARNBOROUGH"             = var.cms_details.upstream_cms_ip_farnborough
    "DEFAULT_UPSTREAM_CMS_MODERN_IP_FARNBOROUGH"      = var.cms_details.upstream_cms_modern_ip_farnborough
    "DEFAULT_UPSTREAM_CMS_DOMAIN_NAME"                = var.cms_details.upstream_cms_domain_name
    "DEFAULT_UPSTREAM_CMS_SERVICES_DOMAIN_NAME"       = var.cms_details.upstream_cms_services_domain_name
    "DEFAULT_UPSTREAM_CMS_MODERN_DOMAIN_NAME"         = var.cms_details.upstream_cms_modern_domain_name
