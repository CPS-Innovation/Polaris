...
resource "azurerm_linux_function_app_slot" "fa_coordinator_staging1" {
  ...
  app_settings = {
    ...
    "PolarisPipelineCoordinatorBaseUrl"            = "https://fa-${local.global_name}-coordinator-staging1.azurewebsites.net/api/"
    "PolarisPipelineTextExtractorBaseUrl"          = "https://fa-${local.global_name}-text-extractor-staging1.azurewebsites.net/api/"
    "PolarisPipelineTextExtractorFunctionAppKey"   = data.azurerm_function_app_host_keys.ak_text_extractor_staging1.default_function_key
    ...
    "PolarisPipelineRedactPdfBaseUrl"              = "https://fa-${local.global_name}-pdf-generator-staging1.azurewebsites.net/api/"
    "PolarisPipelineRedactPdfFunctionAppKey"       = data.azurerm_function_app_host_keys.ak_pdf_generator_staging1.default_function_key
...
resource "azuread_application_password" "faap_fa_coordinator_app_service_staging1" {
...
resource "azurerm_linux_function_app_slot" "fa_coordinator_staging2" {
  ...
  app_settings = {
    ...
    "AzureWebJobsStorage"                          = azurerm_storage_account.sa_coordinator.primary_connection_string
    "CoordinatorOrchestratorTimeoutSecs"           = "600"
    "PolarisPipelineCoordinatorBaseUrl"            = "https://fa-${local.global_name}-coordinator-staging2.azurewebsites.net/api/"
    "PolarisPipelineTextExtractorBaseUrl"          = "https://fa-${local.global_name}-text-extractor-staging2.azurewebsites.net/api/"
    "PolarisPipelineTextExtractorFunctionAppKey"   = data.azurerm_function_app_host_keys.ak_text_extractor_staging2.default_function_key
    "SearchClientAuthorizationKey"                 = azurerm_search_service.ss.primary_key
    "SearchClientEndpointUrl"                      = "https://${azurerm_search_service.ss.name}.search.windows.net"
    "SearchClientIndexName"                        = jsondecode(file("search-index-definition.json")).name
    "BlobServiceUrl"                               = "https://sacps${var.env != "prod" ? var.env : ""}polarispipeline.blob.core.windows.net/"
    ...
    "DdeiBaseUrl"                                  = "https://fa-${local.ddei_resource_name}.azurewebsites.net"
    "DdeiAccessKey"                                = data.azurerm_function_app_host_keys.fa_ddei_host_keys.default_function_key
    "PolarisPipelineRedactPdfBaseUrl"              = "https://fa-${local.global_name}-pdf-generator-staging2.azurewebsites.net/api/"
    "PolarisPipelineRedactPdfFunctionAppKey"       = data.azurerm_function_app_host_keys.ak_pdf_generator_staging2.default_function_key
    "OvernightClearDownEnabled"                    = var.overnight_clear_down_enabled
    "SlidingClearDownEnabled"                      = var.sliding_clear_down_enabled
    "SlidingClearDownInputDays"                    = var.sliding_clear_down_input_days
  }
...
resource "azuread_application_password" "faap_fa_coordinator_app_service_staging2" {
