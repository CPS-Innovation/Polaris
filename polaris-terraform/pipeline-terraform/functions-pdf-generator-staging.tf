resource "azurerm_windows_function_app_slot" "fa_pdf_generator_staging1" {
  ...
  storage_account_name          = azurerm_storage_account.sa_pdf_generator_staging1.name
  storage_account_access_key    = azurerm_storage_account.sa_pdf_generator_staging1.primary_access_key
  ...
  app_settings = {
    "AzureWebJobsStorage"                             = azurerm_storage_account.sa_pdf_generator_staging1.primary_connection_string
    ...
    "WEBSITE_CONTENTAZUREFILECONNECTIONSTRING"        = azurerm_storage_account.sa_pdf_generator_staging1.primary_connection_string
