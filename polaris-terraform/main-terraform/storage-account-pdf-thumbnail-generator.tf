...
resource "azapi_resource" "pipeline_sa_pdf_thumbnail_generator_file_share" {
  ...
  parent_id = "${data.azurerm_subscription.current.id}/resourceGroups/${azurerm_resource_group.rg_thumb_gen.name}/providers/Microsoft.Storage/storageAccounts/${azurerm_storage_account.sa_pdf_thumbnail_generator.name}/fileServices/default"
}
