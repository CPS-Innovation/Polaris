...
resource "azurerm_service_plan" "asp_polaris_pipeline_ep_pdf_thumbnail_generator" {
  ...
  name                         = "asp-pdf-thumbnail-generator-ep-${local.pipeline_resource_name}"
  ...
  maximum_elastic_worker_count = var.pipeline_component_service_plans.pdf_thumbnail_generator_plan_maximum_burst
}